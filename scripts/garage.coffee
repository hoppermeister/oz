...
#
# Commands:
#   oz garage - Displays percentage full of each garage in UCF
#	oz where should I park? - Responds with the most open garage
#	oz how full is garage (garage) - Responds with the percent full of the queried garage
#	
# Author:
